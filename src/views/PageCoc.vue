  ...
  <div class="page-coc">
    <div>
	  ...
	  <p>
	    ...
	    our conference are required to agree with the
	    following code of conduct. Organisers will enforce
	    this code throughout the event. We expect
	    cooperation from all participants to help ensure a
	    safe environment for everybody. 
          ...
          https://www.mscc.mu/content/images/2018/12/be-excellent-to-each-other.jpg
	  ...
	  <p>
	    ...
	    religion (or lack thereof), or technology choices. We do
	    ...
	    and other online media. Conference participants violating
	    these rules may be sanctioned or expelled from the conference
	  ...
	  <p>
	    ...
	    race, ethnicity, religion, technology choices, sexual
	  ...
	  <p>
	    ...
	    In particular, sponsors should not use sexualized images,
	  ...
	  <p>
	    ...
	    can be identified as they&#39;ll be wearing branded
	    t-shirts.
	  </p>
