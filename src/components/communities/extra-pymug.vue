<template>
  <div class="text-flow">
    <span class="tagline">Python, for the love of it!</span>
    <h2 class="group-title">Python Mauritius User Group (pymug)</h2>
    <p>
      The Python Mauritius User Group (pymug) is the local Python user group of
      Mauritius. Our aim is to provide opportunities to everybody to upskill
      ...
      To sum it up, we care about Python education. Our website:
      <a href="https://www.pymug.com">pymug.com</a>
    </p>

    <p>
      We'll be present at the DevCon which is an amazing community-driven event.
    </p>
    ...
    <p>
      ...
      <a href="https://www.pymug.com/assets/pymug_2019_report.pdf"
        >2019 report</a
      >.
    </p>
