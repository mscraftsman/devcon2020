  ...
  <div class="why-attend-section">
    ...
    >
      ...
      <p class="text-xl">
        ...
        elit. Culpa ratione, ea reprehenderit porro doloribus facere assumenda
        tempore amet similique optio animi! Non, incidunt? Atque rem praesentium
        fugit. Sequi, facere quaerat!
      </p>
    </div>
  </div>
</template>
