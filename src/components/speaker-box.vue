<template>
	<div class="speaker-box bg-white" :id="speaker.fullName">
		<div class="speaker-image">
			<img  class =" border-2 border-black" :src="speaker.profilePicture" alt />
		</div>
		<div class="speaker-meta text-center bg-black text-white p-3 h-full">
			<div class="name text-xl text-black bg-white font-hulksmash my-2">{{ speaker.fullName }}</div>
			<div class="occupation text-xs uppercase font-spiderman">{{ speaker.tagLine }}</div>
			<div class="alias"></div>
