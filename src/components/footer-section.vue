  ...
  <div class="bg-black text-white">
    <div class="block md:hidden">
      <div class="container mx-auto text-sm uppercase tracking-wide footer-wrapper">
        <div class="logo w-1/3 mx-auto py-10">
          <router-link :to="{ name: 'pagehome' }">
            <svg version="1.1"
                 ...
                 xml:space="preserve">
              <g id="XMLID_1_">
                <polygon id="XMLID_13_"
                         class="st0"
                         points="214.2,8 96.7,8 3.3,285.9 123.7,285.3 	" />
                <polygon id="XMLID_14_"
                         class="st0"
                         points="310,285.3 400.4,8 282.9,8 189.5,285.9 	" />
                <polygon id="XMLID_15_"
                         class="st0"
                         points="186.6,270.6 247,97.9 218.3,18 160.7,191.3 	" />
                <polygon id="XMLID_16_"
                         class="st0"
                         points="378.1,285.3 497.4,286.5 404.6,18 346.4,193.1 	" />
                <path id="XMLID_17_"
                      class="st0"
                      d="M130.5,398.1c-5.1-4.3-11.3-8.1-18.6-11.2c-7.4-3.1-15.8-5.9-25.2-8.4c-8-2.1-14.6-4-19.8-5.6
		...
		c3.3-7.2,5-15.4,5-24.6v-0.5c0-8.1-1.3-15.1-3.9-21C139.4,407.5,135.6,402.4,130.5,398.1z" />
                <path id="XMLID_18_"
                      class="st0"
                      d="M275.6,449.5c-7.3,3.9-16.3,5.8-27,5.8c-8,0-15.3-1.5-21.9-4.6c-6.6-3.1-12.3-7.3-17-12.6
		...
		c5.1-4.1,10.1-8.7,14.9-13.8l-26-26.3C290.2,440.2,282.9,445.6,275.6,449.5z" />
                <path id="XMLID_19_"
                      class="st0"
                      d="M472.2,433.5c-7.3,6.7-14.6,12-21.9,15.9s-16.3,5.8-27,5.8c-8,0-15.3-1.5-21.9-4.6
        ...
        <ul class="menu px-10 text-center">
          <li>
          ...
          <li>
            <a target="_blank"
               href="https://github.com/mscraftsman/devcon2020/issues">Contribute</a>
          </li>
          <!--          <li>-->
      ...
      <div class="building-crop">
		...
		s11.7-6.4,16.9-10.5c5.1-4.1,10.1-8.7,14.9-13.8L472.2,433.5z" />
          ...
          <ul class="earth-menu">
            ...
            <!--          <li><router-link :to="{ name: 'PagePastEvents' }">Past Events</router-link>
            </li> -->
            <li>
              <router-link :to="{ name: 'PagePress' }">Press</router-link>
            </li>
